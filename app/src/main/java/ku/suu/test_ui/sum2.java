...
public class sum2 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Log.d("result_left1", "sum2 =" + Data_result_left_lv1);
        Log.d("result_right1", "sum2 =" + Data_result_right_lv1);

        Log.d("result_left2", "sum2 =" + Data_result_left_lv2);
        Log.d("result_right2", "sum2 =" + Data_result_right_lv2);
...
//*****************************Process LV5**********************************************************
        ...
        */
//**************************************************************************************************
        btnClick_next1 = (Button) findViewById(R.id.bt_sum2);
        btnClick_next1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent z = new Intent(sum2.this, MainActivity.class);
                startActivity(z);
            }
        });// SetOnclick
