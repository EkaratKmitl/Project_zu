...
public class play_sound_1 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnOK.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent a = new Intent(play_sound_1.this, insert_text_1.class);
                startActivity(a);
                timer.cancel();
            }
        }); // OnClick
    ...
    public class MyTask extends TimerTask {
        ...
        int currentNumber = 0;
        int[] numbers = {R.raw.z_left_lv1,R.raw.z_right_lv1,
                         R.raw.i_left_lv1,R.raw.i_right_lv1,
                         R.raw.p_left_lv1,R.raw.p_right_lv1,
                         R.raw.g_left_lv1,R.raw.g_right_lv1,
                         R.raw.k_left_lv1,R.raw.k_right_lv1,
        };
        ...
        public void run() {
            play_sound_1.this.runOnUiThread(new Runnable() {// <-------- รัน Runnable ในเธรดหลัก เพื่อจะได้เข้าถึง UI ได้
                ...
                public void run() {
                    ...
                    if (x == 0) {
                        mpBgm = MediaPlayer.create(play_sound_1.this, numbers[currentNumber++]);
                        mpBgm.start();
