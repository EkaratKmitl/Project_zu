...
public class countdown_lv3 extends Activity {
...
// Text View, Progress Bar และ Toggle Button ในหน้า Layout
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.countdown_lv3);
...
//กำหนดค่าให้กับ Button และเรียกใช้ OnCheckedChangeListener***********************************************
        btnCount = (ToggleButton)findViewById(R.id.bt_countdown_lv3);
                ...
                if (isChecked) {
                    ...
                    cdt = new CountDownTimer(2000, 50) {
                        ...
                        public void onFinish() {
                            Intent intent = new Intent(countdown_lv3.this,play_sound_3.class);
