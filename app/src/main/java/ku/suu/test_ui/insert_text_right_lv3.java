...
public class insert_text_right_lv3 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        final EditText edtInput = (EditText) findViewById(R.id.editText3);

        final Button btnClickForInput = (Button) findViewById(R.id.bt_insert_text_3);
        btnClickForInput.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SharedPreferences sp = getSharedPreferences("Data_compare_text_right_lv3", Context.MODE_PRIVATE);
                SharedPreferences.Editor editor = sp.edit();
                editor.putInt("Data_compare_text_right_lv3", num);
                editor.commit();
...
//***************บรรทึกค่สลง SQLit ******************************************************************
                ...
                SharedPreferences sf = getSharedPreferences("Data_compare_text_left_lv3", Context.MODE_PRIVATE);
                int Data_compare_text_left_lv3 = sf.getInt("Data_compare_text_left_lv3", -1);
                ...
                SharedPreferences sh = getSharedPreferences("Data_compare_text_right_lv3", Context.MODE_PRIVATE);
                int Data_compare_text_right_lv3 = sh.getInt("Data_compare_text_right_lv3", -1);

//*************แสดงการเปรียบเทียบค่าที่ได้ (sound Text) Left and  (sound Text) Right *********************
                int result_true = 1;
                int result_fale = 0;

                if (Data_compare_text_left_lv3 == Data_compare_sound_left_lv3) {

                    if (Data_compare_text_right_lv3 == Data_compare_sound_right_lv3) {

                        SharedPreferences ca = getSharedPreferences("Data_result_left_lv3", Context.MODE_PRIVATE);
                        editor = ca.edit();
                        editor.putInt("Data_result_left_lv3", result_true);
                        editor.commit();

                        SharedPreferences cb = getSharedPreferences("Data_result_right_lv3", Context.MODE_PRIVATE);
                        editor = cb.edit();
                        editor.putInt("Data_result_right_lv3", result_true);
...
//**********************************************************************************************
                        Intent a = new Intent(insert_text_right_lv3.this, sum3.class);
                        startActivity(a);

                    } else {
                        SharedPreferences cc = getSharedPreferences("Data_result_left_lv3", Context.MODE_PRIVATE);
                        editor = cc.edit();
                        editor.putInt("Data_result_left_lv3", result_true);
                        editor.commit();
                        SharedPreferences cd = getSharedPreferences("Data_result_right_lv3", Context.MODE_PRIVATE);
                        editor = cd.edit();
                        editor.putInt("Data_result_right_lv3", result_fale);
                        editor.commit();

                        Intent b = new Intent(insert_text_right_lv3.this,play_sound_left_lv4.class);
                        startActivity(b);
                    ...
                    if(Data_compare_text_right_lv3 == Data_compare_sound_right_lv3){
                        ...
                        editor = ce.edit();
                        editor.putInt("Data_result_left_lv3", result_fale);
                        editor.commit();


                        SharedPreferences cae = getSharedPreferences("Data_result_right_lv3", Context.MODE_PRIVATE);
                        editor = cae.edit();
                        editor.putInt("Data_result_right_lv3", result_true);
                        editor.commit();

                        Intent a = new Intent(insert_text_right_lv3.this, play_sound_left_lv4.class);
                        startActivity(a);


                    }else {

                        SharedPreferences cg = getSharedPreferences("Data_result_left_lv3", Context.MODE_PRIVATE);
                        editor = cg.edit();
                        editor.putInt("Data_result_left_lv3", result_fale);
                        editor.commit();
