...
public class sum3 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState){
        ...
        Log.d("result_left", "num3 =" + Data_result_left_lv1);
        Log.d("result_right", "num3 =" + Data_result_right_lv1);
        ...
        Log.d("result_left", "num3 =" + Data_result_left_lv2);
        Log.d("result_right", "num3 =" + Data_result_right_lv2);;
        ...
        Log.d("result_left1", "sum3 =" + Data_result_left_lv1);
        Log.d("result_right1", "sum3 =" + Data_result_right_lv1);

        Log.d("result_left2", "sum3 =" + Data_result_left_lv2);
        Log.d("result_right2", "sum3 =" + Data_result_right_lv2);

        Log.d("result_left3", "sum3 =" + Data_result_left_lv3);
        Log.d("result_right3", "sum3 =" + Data_result_right_lv3);

                        /*        SharedPreferences da = getSharedPreferences("Data_result_left_lv3", Context.MODE_PRIVATE);
                                int Data_result_left_lv4 = da.getInt("Data_result_left_lv3", -1);
...
//*****************************Process LV5**********************************************************
        ...
        */
//**************************************************************************************************
        btnClick_next1 = (Button) findViewById(R.id.bt_sum3);
        btnClick_next1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent z = new Intent(sum3.this, MainActivity.class);
                startActivity(z);
            }
        });// SetOnclick
