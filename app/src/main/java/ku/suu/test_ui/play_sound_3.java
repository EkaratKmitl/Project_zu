...
public class play_sound_3 extends Activity {
    MediaPlayer mpBgm;
    Timer timer;
    Button btnOK;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.play_sound_3);
        ...
        btnOK.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent a = new Intent(play_sound_3.this, insert_text_3.class);
                startActivity(a);
                timer.cancel();
            }
        }); // OnClick
    ...
    public class MyTask extends TimerTask {
        int x = 1;
        int currentNumber = 0;
        int[] numbers = {R.raw.p_left_lv3,R.raw.p_right_lv3,
        ...
        @Override
        public void run() {
            play_sound_3.this.runOnUiThread(new Runnable() {// <-------- รัน Runnable ในเธรดหลัก เพื่อจะได้เข้าถึง UI ได้
                @Override
                public void run() {

                    if (x == 0) {
                        mpBgm = MediaPlayer.create(play_sound_3.this, numbers[currentNumber++]);
                        mpBgm.start();
                        ...
                        SharedPreferences sp = getSharedPreferences("Data_compare_folder3", Context.MODE_PRIVATE);
                        ...
                        editor.putInt("Data_compare_row3",currentNumber );
